...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if isinstance(insect,QueenAnt) and insect.is_truequeen:
                return
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while range <= self.min_range:
            ...
            range += 1
        while cur_place != hive and cur_place.bee == []:
            cur_place=cur_place.entrance
            range += 1
        while cur_place == hive or range > self.max_range:
            return None
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_truequeen:
            ...
            while next_place:
                if next_place.ant:
                    if next_place.ant.is_container:
                       if next_place.ant.contain_ant and not next_place.ant.contain_ant.buffed:
                           next_place.ant.contain_ant.damage *= 2
                           next_place.ant.contain_ant.buffed = True
                    if hasattr(next_place.ant,'damage') and not next_place.ant.buffed:
                       next_place.ant.damage *= 2
                       next_place.ant.buffed = True
